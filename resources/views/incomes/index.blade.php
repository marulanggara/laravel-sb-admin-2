...
<div class="mb-4">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0 font-weight-bold text-primary">Income List</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                ...
                <tbody id="income-table-body">   
                        @foreach ($monthsAvailable as $month)
                            <tr>
                                ...
                                <td>
                                    @can('update invoice')
                                    <a href="{{ route('incomes.show', ['month' => $month['num'], 'year' => $month['year'], 'start_date' => request('start_date'), 'end_date' => request('end_date')]) }}"
...
<script>
    $(function () {
        ...
        $(document).on('click', '.detail-btn', function (e) {
            ...
            window.location.href = `{{ route('incomes.show') }}?month=${month}&year=${year}&start_date=${startDate}&end_date=${endDate}`;
        });
    });
</script>
@endsection